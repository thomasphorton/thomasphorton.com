...
## Architecture
![The Raspberry Pi reads from the GPS sensor and sends information to AWS IoT via MQTT. The data is then fanned out to DynamoDB with the IoT Rules engine.](./mariah-architecture.png)
